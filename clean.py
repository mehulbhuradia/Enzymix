...
def sample_one(idx):
    ...
    traj = model.sample(coords, one_hot, edges,batch_size, pbar=True, sample_structure=False, sample_sequence=False)
    return traj,res_len
        ...
        while True:
            try:
                ...
                if error_count > 20:
                    ...
                    continue
        fasta_content_i,global_counter = make_pdb(traj, res_len, global_counter,folder_path=folder_path+"/pdb/",num=100)
