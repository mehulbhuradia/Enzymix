...
# print(get_last_layer_repr("CCO"))
print(get_last_layer_repr("CCO").shape)
# print(get_last_layer_repr("CCO").dtype)
# CC
print(get_last_layer_repr("CC").shape)
# O=C([C@@H]1OC(O)[C@@H](O)[C@H](O)[C@H]1O)C
print(get_last_layer_repr("O=C([C@@H]1OC(O)[C@@H](O)[C@H](O)[C@H]1O)C").shape)